...
class RegisterFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'over_name_kana' => 'required|string|regex:/^[ァ-ヶー]+$/u|min:1|max:30',
            'under_name_kana' => 'required|string|regex:/^[ァ-ヶー]+$/u|min:1|max:30',
            ...
            'birthday' => 'required|date|after:"1999-12-31"|before:"now"'
        ];
    }
